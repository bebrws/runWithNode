all: runWithLib testp dynlib.dylib bradsnode.dylib filenode.dylib
...
bradsnode.dylib: node/out/Release/libnode.a
...
filenode.dylib: node/out/Release/libnode.a
...
demoFile: runWithLib filenode.dylib
